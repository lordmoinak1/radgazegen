...
def test_radgazegen():
    base_model_path = "/path/to/stable_diffusion_v1_5_mimic_15k/"
    ...
    for name, text in tqdm(zip(df['file_name'], df['text'])):
        ...
        image.save("/path/to/reflacx/radgazegen_hva/{}".format(name))
...
def test_sd():
    ...
    for name, text in tqdm(zip(df['file_name'], df['text'])):
        ...
        image.save("/path/to/reflacx/sd/{}".format(name))
...
def test_roentgen():
    ...
    for name, text in tqdm(zip(df['file_name'], df['text'])):
        ...
        image.save("/path/to/reflacx/roentgen/{}".format(name))
...
def test_controlnet():
    ...
    for name, text in tqdm(zip(df['file_name'], df['text'])):
        ...
        image.save("/path/to/reflacx/controlnet_gl/{}".format(name))
...
def test_multicontrolnet():
    ...
    for name, text in tqdm(zip(df['file_name'], df['text'])):
        ...
        image.save("/path/to/reflacx/multicontrolnet_segmentation/{}".format(name))
